...
<?php
   ...
   /*  echo "<pre>";
    ...
    $xml = file_get_contents("https://wwwlab.iit.his.se/gush/XMLAPI/bookservice/authors/?".$writer);
    $dom = new DomDocument;
    ...
    /* echo "<div id=form_body>";
      ...
      echo "You selected <span style='background-color:white; margin-left:5px; padding:5px; padding-left:15px; padding-right:15px; border:1px solid black;'>$writer</span></h3>";
